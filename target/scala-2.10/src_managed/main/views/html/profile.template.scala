                    ...
                    <form id="registration" name="registration" novalidate class="form-horizontal" action='' method="POST" ng-controller="registerController">
                        <fieldset>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <button class="btn" ng-disabled="registration.$invalid || (login.password != login.cpassword) || (login.image == null || login.image=='')" ng-click="editAccounte()">
                                        Save</button>
